...
user in an INI file next to DuckDuckGoBrowserPortable.exe called DuckDuckGoBrowserPortable.ini.
...
copy AppNamePortable.ini from this directory to DuckDuckGoBrowserPortable.ini next to
DuckDuckGoBrowserPortable.exe. The options in the INI file are as follows:
